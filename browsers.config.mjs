...
const BrowserStack = {
  defaultBrowsers: ['chrome', 'firefox', 'safari_minus2'], // Safari > 14 has the connection issue on BrowserStack
  supportedBrowsers: [
    'chrome', 'chrome_minus1', 'chrome_minus2',
  ...
  availableBrowsers: [
    ...
    // Safari v16, and v15 are moved out from default and supported temporary because BrowserStack connection issue
    'safari', 'safari_minus1',
  ]
};
...
BrowserStack.config = {
  ...
  android: { ...deviceConfig, browser: 'samsung', device: 'Samsung Galaxy S23', os: 'android', os_version : '13.0' },

  // Mobile Devices minus1 versions
  ios_minus1: { ...deviceConfig, browser: 'iphone',  device: 'iPhone 13',          os: 'ios',     os_version : '15' },
  android_minus1:    { ...deviceConfig, browser: 'samsung', device: 'Samsung Galaxy S22', os: 'android', os_version : '12.0' },

  // Mobile Devices minus2 versions
  ios_minus2: { ...deviceConfig, browser: 'iphone',  device: 'iPhone 12',          os: 'ios',     os_version : '14' },
  android_minus2:    { ...deviceConfig, browser: 'samsung', device: 'Samsung Galaxy S21', os: 'android', os_version : '11.0' }
};
