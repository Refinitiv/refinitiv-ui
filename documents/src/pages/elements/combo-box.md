...
## Usage
The `ef-combo-box` uses the `data` property `ComboBoxData` interface that extends from [Data Item](./custom-components/utils/data-management#data-item) interface.
