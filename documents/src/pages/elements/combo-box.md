...
## Usage
The `ef-combo-box` uses the `data` property of [ComboBoxData](https://github.com/Refinitiv/refinitiv-ui/blob/v7/packages/elements/src/combo-box/helpers/types.ts) interface that extends from [Data Item](./custom-components/utils/data-management#data-item) interface.
