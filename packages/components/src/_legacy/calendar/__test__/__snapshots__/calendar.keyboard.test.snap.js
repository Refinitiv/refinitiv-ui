...
snapshots["calendar/KeyboardNavigation Day View Can switch months using arrow keys Should switch months forward when use left arrow key"] = 
`<div
...
`;
/* end snapshot calendar/KeyboardNavigation Day View Can switch months using arrow keys Should switch months forward when use left arrow key */

snapshots["calendar/KeyboardNavigation Day View Can switch months using arrow keys Should switch months forward when use right arrow key"] = 
`<div
  aria-label="Selected none. Choose date"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/KeyboardNavigation Day View Can switch months using arrow keys Should switch months forward when use right arrow key */

snapshots["calendar/KeyboardNavigation Month View Can switch years using arrow keys Should switch year forward when use left arrow key"] = 
`<div
  aria-label="Selected none. Choose date"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/KeyboardNavigation Month View Can switch years using arrow keys Should switch year forward when use left arrow key */

snapshots["calendar/KeyboardNavigation Month View Can switch years using arrow keys Should switch year forward when use right arrow key"] = 
`<div
  aria-label="Selected none. Choose date"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/KeyboardNavigation Month View Can switch years using arrow keys Should switch year forward when use right arrow key */

snapshots["calendar/KeyboardNavigation Year View Can switch decades using arrow keys Should switch decades back when use left arrow key"] = 
`<div
  aria-label="Selected none. Choose date"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/KeyboardNavigation Year View Can switch decades using arrow keys Should switch decades back when use left arrow key */

snapshots["calendar/KeyboardNavigation Year View Can switch decades using arrow keys Should switch decades forward when use right arrow key"] = 
`<div
  aria-label="Selected none. Choose date"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/KeyboardNavigation Year View Can switch decades using arrow keys Should switch decades forward when use right arrow key */
