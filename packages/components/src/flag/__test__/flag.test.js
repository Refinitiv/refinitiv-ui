...
describe('flag/Flag', () => {
  ...
  describe('Should Have Correct DOM Structure', () => {
    it('without flag or src attributes', async () => {
      const el = await createAndWaitForLoad('<ds-flag></ds-flag>');
    ...
    it('with valid flag attribute', async () => {
      ...
      const el = await createAndWaitForLoad(`<ds-flag flag="${flagName}"></ds-flag>`);
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with valid src attribute', async () => {
      createFakeResponse(gbSvg, responseConfigSuccess);
      const el = await createAndWaitForLoad('<ds-flag src="https://mock.cdn.com/flags/ticks.svg"></ds-flag>');
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with invalid flag attribute', async () => {
      ...
      const el = await createAndWaitForLoad('<ds-flag flag="invalid"></ds-flag>');
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with invalid src attribute', async () => {
      createFakeResponse('', responseConfigError);
      const el = await createAndWaitForLoad('<ds-flag src="https://mock.cdn.com/flags/invalid.svg"></ds-flag>');
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with empty flag attribute', async () => {
      createFakeResponse('', responseConfigError);
      const el = await createAndWaitForLoad('<ds-flag flag=""></ds-flag>');
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with empty src attribute', async () => {
      createFakeResponse('', responseConfigError);
      const el = await createAndWaitForLoad('<ds-flag src=""></ds-flag>');
      const svg = el.shadowRoot.querySelector('svg');
    ...
    it('with unsafe nodes in response', async () => {
      ...
      const el = await createAndWaitForLoad('<ds-flag flag="malicious"></ds-flag>');
  ...
  describe('Functional Tests', () => {
    ...
    it('should make a correct server request based on cdn prefix and the flag if flag is specified', async () => {
      ...
      const el = await createAndWaitForLoad(`<ds-flag flag="${uniqueFlagName}"></ds-flag>`);
      const CDNPrefix = el.getComputedVariable('--cdn-prefix');
    ...
    it('should make a correct server request based on src', async () => {
      ...
      await createAndWaitForLoad(`<ds-flag src="${uniqueSrc}"></ds-flag>`);
      expect(fetch.callCount).to.equal(1, 'Should make one request');
