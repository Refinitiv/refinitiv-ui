...
describe('input-field/InputField', () => {
  ...
  describe('Accessibility', () => {
    it('Should pass when `aria-label` was set on component', async () => {
      const el = await fixture('<ds-sub-text-field aria-label="Text Field"></ds-sub-text-field>');
    ...
    it('Should be accessible with `aria-labelledby`', async () => {
      ...
      const el = await fixture(`<ds-sub-text-field id="txt" aria-labelledby="label sub-label"></ds-sub-text-field>`);
      await expect(el).to.be.accessible();
    });
    it('Should be accessible with `for` attribute on label', async () => {
      await fixture('<label for="text">Text Field</label>');
      const el = await fixture('<ds-sub-text-field id="text"></ds-sub-text-field>');
      await expect(el).to.be.accessible();
    });
    it('Should propagate `aria-description` attribute to input correctly', async () => {
      const el = await fixture('<ds-sub-text-field aria-description="Text Field"></ds-sub-text-field>');
    ...
    it('Should propagate `aria-describedby` attribute to input correctly', async () => {
      ...
      const el = await fixture('<ds-sub-text-field aria-describedby="helper-message error-message"></ds-sub-text-field>');
