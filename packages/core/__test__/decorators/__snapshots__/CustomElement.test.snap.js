...
snapshots["TestCustomElement Test create and exec decorator with no theme twice"] = 
...
`;
/* end snapshot TestCustomElement Test create and exec decorator with no theme twice */
