 ...
 *
 * @fires item-highlight Fired when user highlighted an item or remove highlight from the item.
 ...
 * @fires item-select Fired when user selected an item on autosuggest.
 ...
 * @fires suggestions-query Fired when user changed value in input control and you might need to update suggestion item accordingly.
 * @fires suggestions-changed Fired when suggestions data changed.
 *
