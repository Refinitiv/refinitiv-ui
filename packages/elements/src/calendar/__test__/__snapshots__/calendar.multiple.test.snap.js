...
snapshots["calendar/Multiple Multiple Test Multiple: should be possible to select values by passing property"] = 
`<div
...
`;
/* end snapshot calendar/Multiple Multiple Test Multiple: should be possible to select values by passing property */

snapshots["calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected days should be highlighted"] = 
`<div
...
`;
/* end snapshot calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected days should be highlighted */

snapshots["calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected months should be highlighted"] = 
`<div
  aria-label="Selected 3 dates, Thursday, 21 April 2005 and others"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected months should be highlighted */

snapshots["calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected years should be highlighted"] = 
`<div
  aria-label="Selected 3 dates, Thursday, 21 April 2005 and others"
  aria-live="polite"
  part="aria-selection"
...
`;
/* end snapshot calendar/Multiple Multiple Test Multiple: selected values should be highlighted Selected years should be highlighted */
