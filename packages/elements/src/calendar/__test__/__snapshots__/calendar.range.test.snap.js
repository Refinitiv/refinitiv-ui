...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted Should be highlighted in day view */
...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted Should be highlighted in month view */
...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted Should be highlighted in year view */
...
>
  ...
  >
    ...
    >
      <div
        aria-label="Selected: Tuesday, 1 March 2005"
        part="cell-content selection selectable"
        role="button"
        tabindex="0"
      >
...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted across months and years Should be highlighted in day view */
...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted across months and years Should be highlighted in month view */
...
`;
/* end snapshot calendar/Range Range Range: selected values should be highlighted across months and years Should be highlighted in year view */
...
`;
/* end snapshot calendar/Range Range AD/BC Range: selected values should be highlighted Should be highlighted in day view */
...
`;
/* end snapshot calendar/Range Range AD/BC Range: selected values should be highlighted Should be highlighted in month view */
...
`;
/* end snapshot calendar/Range Range AD/BC Range: selected values should be highlighted Should be highlighted in year view */
...
`;
/* end snapshot calendar/Range Navigation Range Value It should be possible to select range values on click */
