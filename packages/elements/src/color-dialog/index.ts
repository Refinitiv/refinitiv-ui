 ...
 * @fires opened-changed - Fired when the user changed open state of the dialog e.g. when users press escape or use close button to close the dialog. The event is not triggered if `opened` property is changed programmatically.
 *
