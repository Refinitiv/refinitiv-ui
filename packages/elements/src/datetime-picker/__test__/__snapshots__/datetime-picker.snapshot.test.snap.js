...
snapshots["datetime-picker/DOMStructure DOM Structure DOM structure is correct when add custom cell slot of calendar prefix"] = 
`<div part="input-wrapper">
  <ef-text-field
    id="input"
    part="input"
...
`;
/* end snapshot datetime-picker/DOMStructure DOM Structure DOM structure is correct when add custom cell slot of calendar prefix */
...
snapshots["datetime-picker/DOMStructure DOM Structure DOM structure is correct when add custom cell slot of calendar while opened"] = 
`<div part="input-wrapper">
  <ef-text-field
    id="input"
    part="input"
...
`;
/* end snapshot datetime-picker/DOMStructure DOM Structure DOM structure is correct when add custom cell slot of calendar while opened */
