...
describe('datetime-picker/View', () => {
  describe('View Test', () => {
    ...
    it('Views are propagated to calendars', async () => {
      const el = await fixture('<ef-datetime-picker lang="en-gb" range duplex opened></ef-datetime-picker>');
    ...
    it('Passing empty string should reset views to default', async () => {
      const el = await fixture('<ef-datetime-picker lang="en-gb" range duplex views="2020-01,2020-04"></ef-datetime-picker>');
      el.view = '';
      await elementUpdated(el);
    ...
    it('In duplex mode calendar view should be in sync', async () => {
      const el = await fixture('<ef-datetime-picker lang="en-gb" duplex opened></ef-datetime-picker>');
