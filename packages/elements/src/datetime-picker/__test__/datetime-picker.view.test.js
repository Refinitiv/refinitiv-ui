...
describe('DatetimePicker', () => {
  describe('View Test', () => {
    ...
    it('Check default view duplex=split', async () => {
      const el = await fixture('<ef-datetime-picker duplex="split"></ef-datetime-picker>');
    ...
    it('Check duplex view when values set', async () => {
      const el = await fixture('<ef-datetime-picker duplex values="2020-04-21,2020-06-21"></ef-datetime-picker>');
    ...
    it('Check duplex="split" view when values set', async () => {
      const el = await fixture('<ef-datetime-picker duplex="split" values="2020-04-21,2020-06-21"></ef-datetime-picker>');
      expect(el.views[0]).to.be.equal('2020-04', 'View from should be adjusted to from value');
    ...
    it('Duplex split range view changes when typing the value', async () => {
      const el = await fixture('<ef-datetime-picker duplex="split" range></ef-datetime-picker>');
    ...
    it('Views are propagated to calendars', async () => {
      const el = await fixture('<ef-datetime-picker range duplex="split" opened></ef-datetime-picker>');
    ...
    it('Passing empty string should reset views to default', async () => {
      const el = await fixture('<ef-datetime-picker range duplex="split" views="2020-01,2020-04"></ef-datetime-picker>');
      el.view = '';
      await elementUpdated(el);
