...
describe('number-field/Step', function () {
  describe('Step', function () {
    it('Default (no arguments), Step Up', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      await expectValues(el, [1, 2, 3, 4, 5], UP);
    });
    it('Default (no arguments), Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      await expectValues(el, [-1, -2, -3, -4, -5], DOWN);
    });
    it('value (property) = 1, Step Up', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '1';
      await expectValues(el, [2, 3, 4, 5, 6], UP);
    });
    it('value (property) = 1, Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '1';
      await expectValues(el, [0, -1, -2, -3, -4], DOWN);
    });
    it('value (property) = 0.5, Step Up', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '0.5';
      await expectValues(el, [1, 2, 3, 4, 5], UP);
    });
    it('value (property) = 0.5, Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '0.5';
      await expectValues(el, [0, -1, -2, -3, -4], DOWN);
    });
    it('value (property) = 1.1, Step Up', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '1.1';
      await expectValues(el, [2, 3, 4, 5, 6], UP);
    });
    it('value (property) = 1.1, Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      el.value = '1.1';
      await expectValues(el, [1, 0, -1, -2, -3], DOWN);
    });
    it('step = 0.3, Step Up', async function () {
      const el = await fixture('<ef-number-field step="0.3"></ef-number-field>');
      await expectValues(el, [0.3, 0.6, 0.9, 1.2, 1.5], UP);
    });
    it('step = 0.3, Step Down', async function () {
      const el = await fixture('<ef-number-field step="0.3"></ef-number-field>');
      await expectValues(el, [-0.3, -0.6, -0.9, -1.2, -1.5], DOWN);
    });
    it('step = 0.0000001, Step Up', async function () {
    ...
    it('min = -0.11, max = 0.45, step = 0.09, Step Down', async function () {
      const el = await fixture('<ef-number-field min="-0.11" max="0.45" step="0.09"></ef-number-field>');
      await expectValues(el, [-0.02, -0.11, -0.11, -0.11, -0.11], DOWN);
    });
    it('step = 0.33, value (attribute) = 2, Step Up', async function () {
    ...
    it('step = 0.33, value (attribute) = 2, Step Down', async function () {
      const el = await fixture('<ef-number-field step="0.33" value="2"></ef-number-field>');
      el.value = ''; // here to keep base of 2 from value attribute
  ...
  describe('Invalid Values', function () {
    ...
    it('Infinity should be covered', async function () {
      const el = await fixture(
        '<ef-number-field min="Infinity" max="Infinity" step="Infinity"></ef-number-field>'
      );
      await expectValues(el, [1, 2], UP);
    });
    it('Any step must never fail on validation', async function () {
    ...
    it('When min > max do nothing', async function () {
  ...
  describe('Step Factor', function () {
    it('factor="2", Step Up', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
      await expectValues(el, [2, 4, 6, 8, 10], UP, 2);
    });
    it('factor="2", Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
    ...
    it('factor="1.5", Step Down', async function () {
      const el = await fixture('<ef-number-field></ef-number-field>');
