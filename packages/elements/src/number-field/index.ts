 ...
 * @fires step-down - Fired when user acts value down on both pressing arrow down or tapping the spinner up. The event is not triggered if the spinner down is called programmatically.
 *
