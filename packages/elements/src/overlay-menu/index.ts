 ...
 * @fires opened-changed - Fired when the user changes open state of the overlay e.g. when the user presses escape key or uses close button to close the overlay.
 *
...
export class OverlayMenu extends Overlay {
  ...
  protected override firstUpdated(changedProperties: PropertyValues): void {
    ...
    this.renderRoot.addEventListener('mousemove', (event) =>
      this.onItemMouseMove(event as MouseEvent)
    ); /* listen shadow root to support data */
  }
