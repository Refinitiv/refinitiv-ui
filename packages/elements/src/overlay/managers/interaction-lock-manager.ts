...
export class ScrollLockManager {
  ...
  private lockEvents(): void {
    ...
    const scrollEventConf = {
      capture: true,
      passive:
        true /* passive improves scrolling performance. See https://developers.google.com/web/tools/lighthouse/audits/passive-event-listeners how. This does not work in IE11 */
    };
