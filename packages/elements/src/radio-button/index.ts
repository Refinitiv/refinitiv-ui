 ...
 * Basic radio button
 *
 * @fires checked-changed - Fired when the user checked or unchecked the radio. The event is not fired if the `checked` property is changed by programmatically.
 *
