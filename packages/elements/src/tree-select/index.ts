 ...
 * @fires query-changed - Fired when the user changes value in the input to change a query word. If `query-debounce-rate` is set, this event will be triggered after debounce completion.
 * @fires opened-changed - Fired when the user opens or closes control's popup.
 */
