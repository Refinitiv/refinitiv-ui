...
const translations = {
  ...
  SELECTED:
    '{value, select, null {未選擇。請選擇時間} other {所選時間是: {showSeconds, select, true {{amPm, select, true {{value, time, ::hmsa}} other {{value, time, ::Hms}}}} other {{amPm, select, true {{value, time, ::hma}} other {{value, time, ::Hm}}}}}}}'
};
