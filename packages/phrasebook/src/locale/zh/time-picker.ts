...
const translations = {
  ...
  SELECTED:
    '{value, select, null {未选择。请选择时间} other {所选时间是: {showSeconds, select, true {{amPm, select, true {{value, time, ::hmsa}} other {{value, time, ::Hms}}}} other {{amPm, select, true {{value, time, ::hma}} other {{value, time, ::Hm}}}}}}}'
};
