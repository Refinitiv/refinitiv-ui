...
describe('isHex', function() {
  it('should return true for valid hex value', async function() {
    expect(isHex('#FFF')).to.equal(true);
    expect(isHex('#123ABC')).to.equal(true);
  });

  it('should return false for invalid hex value', async function() {
...
describe('removeHashSign', function() {
  it('should remove hash sign from hex value', async function() {
    expect(removeHashSign('#FFF')).to.equal('FFF');
  });

  it('should return hex value if it does not start with hash sign', async function() {
    expect(removeHashSign('FFF')).to.equal('FFF');
  });
});
