 ...
 */
const isElementOverflown = (target: HTMLElement): boolean =>
  target.scrollWidth - target.offsetWidth >= 1 || target.scrollHeight - target.offsetHeight >= 1;

export { getElementScope, isElementOverflown };
