/**
 * This file is the same @open-wc/karma-esm/src/setup-es-dev-server.js
 * but it has override Regex for support Karma 6, you can see the changed
 * by search `@override` text.
 */
const fs = require('fs');
